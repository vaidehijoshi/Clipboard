class WorkBuddy < ActiveRecord::Base
  belongs_to :buddy_one, class_name: "Student", foreign_key: "buddy_one_id"
  belongs_to :buddy_two, class_name: "Student", foreign_key: "buddy_two_id"
